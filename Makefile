...
open:
	@ open App/Magic-Gallery.xcworkspace

clean:
	@ echo "\033[1;37mCleaning up project files\033[0m"
	@ rm -rf App/Magic-Gallery.xc* App/Podfile.lock App/Pods
	@ find App/Magic-Gallery/Resources/Generated ! -name '.gitkeep' -type f -exec rm -f {} +
